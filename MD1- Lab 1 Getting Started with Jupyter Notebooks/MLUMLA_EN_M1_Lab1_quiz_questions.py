...
question_1 = Quiz(
    question={
        "question": "How do you know if a cell is running in a notebook?",
        "options": [
            "To the left of the cell, an asterisk appears instead of a number.",
            "The circle next to the kernel name at the top-right of the notebook is filled.",
            "Both ways are valid.",
        ],
        "correctIndex": 2,
    }
...
question_2 = Quiz(
    question={
        "question": "What is the sequence of menu options to select to restart the kernel in a notebook?",
        "options": [
